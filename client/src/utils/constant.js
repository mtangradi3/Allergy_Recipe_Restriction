...
export const GET_MEAL_INGREDIENTS =  "http://localhost:8080/api/meal/get_meal_ingredients";

// For group creation, displaying all groups
export const GET_ALL_GROUPS =  "http://localhost:8080/api/group/get_all_groups_name";
...
export const GET_GROUP_FOODS = "http://localhost:8080/api/group/get_foods_group_can_eat";

export const DELETE_GROUP = "http://localhost:8080/api/group/delete_group";

export const REMOVE_USER_FROM_GROUP = "http://localhost:8080/api/user/remove_user_from_froup";
